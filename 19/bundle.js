...
/* harmony import */ var _utils_const__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/const */ "./src/utils/const.js");
/* harmony import */ var _view_point_add_view__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/point-add-view */ "./src/view/point-add-view.js");
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
class PointNewPresenter {
  constructor(pointListContainer, changeData) {
    ...
    _defineProperty(this, "init", () => {
      ...
      _classPrivateFieldSet(this, _pointAddComponent, new _view_point_add_view__WEBPACK_IMPORTED_MODULE_2__["default"]());
    ...
    _classPrivateFieldInitSpec(this, _handleFormSubmit, {
      writable: true,
      value: task => {
        _classPrivateFieldGet(this, _changeData).call(this, _utils_const__WEBPACK_IMPORTED_MODULE_1__.UserAction.ADD_POINT, _utils_const__WEBPACK_IMPORTED_MODULE_1__.UpdateType.MINOR, {
          id: (0,nanoid__WEBPACK_IMPORTED_MODULE_3__.nanoid)(),
          ...task
        });
...
class PointPresenter {
  constructor(tripPointsListElement, changeData, changeMode) {
    ...
    _classPrivateFieldInitSpec(this, _handleFavoriteClick, {
      writable: true,
      value: () => {
        _classPrivateFieldGet(this, _changeData).call(this, _utils_const_js__WEBPACK_IMPORTED_MODULE_3__.UserAction.UPDATE_POINT, _utils_const_js__WEBPACK_IMPORTED_MODULE_3__.UpdateType.MINOR, { ..._classPrivateFieldGet(this, _tripPoint),
...
/* harmony import */ var _view_no_trip_points_view_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/no-trip-points-view.js */ "./src/view/no-trip-points-view.js");
...
/* harmony import */ var _utils_point_sort_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utils/point-sort.js */ "./src/utils/point-sort.js");
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
class TripPresenter {
  constructor(mainElement, pointsModel, filterModel) {
    ...
    _classPrivateFieldInitSpec(this, _tripPointsListElement, {
      writable: true,
      value: new _view_points_list_view_js__WEBPACK_IMPORTED_MODULE_1__["default"]()
    });
    ...
    _classPrivateFieldInitSpec(this, _currentSortType, {
      writable: true,
      value: _utils_const_js__WEBPACK_IMPORTED_MODULE_7__.SortType.SORT_DAY
    });

    _classPrivateFieldInitSpec(this, _filterType, {
      writable: true,
      value: _utils_const_js__WEBPACK_IMPORTED_MODULE_7__.FilterType.EVERYTHING
    });
    ...
    _defineProperty(this, "createPoint", () => {
      _classPrivateFieldSet(this, _currentSortType, _utils_const_js__WEBPACK_IMPORTED_MODULE_7__.SortType.SORT_DAY);

      _classPrivateFieldGet(this, _filterModel).setFilter(_utils_const_js__WEBPACK_IMPORTED_MODULE_7__.UpdateType.MAJOR, _utils_const_js__WEBPACK_IMPORTED_MODULE_7__.FilterType.EVERYTHING);
    ...
    _classPrivateFieldInitSpec(this, _renderNoTasks, {
      writable: true,
      value: () => {
        _classPrivateFieldSet(this, _noTripPointsComponent, new _view_no_trip_points_view_js__WEBPACK_IMPORTED_MODULE_2__["default"](_classPrivateFieldGet(this, _filterType)));

        (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_0__.render)(_classPrivateFieldGet(this, _tripPointsElement), _classPrivateFieldGet(this, _noTripPointsComponent), _utils_render_js__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.BEFOREEND);
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _renderTripPointsListElement, {
      writable: true,
      value: () => {
        (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_0__.render)(_classPrivateFieldGet(this, _tripPointsElement), _classPrivateFieldGet(this, _tripPointsListElement), _utils_render_js__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.BEFOREEND);
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _handleViewAction, {
      ...
      value: (actionType, updateType, update) => {
        switch (actionType) {
          case _utils_const_js__WEBPACK_IMPORTED_MODULE_7__.UserAction.UPDATE_POINT:
            _classPrivateFieldGet(this, _pointsModel).updatePoint(updateType, update);

            break;

          case _utils_const_js__WEBPACK_IMPORTED_MODULE_7__.UserAction.ADD_POINT:
            _classPrivateFieldGet(this, _pointsModel).addPoint(updateType, update);

            break;

          case _utils_const_js__WEBPACK_IMPORTED_MODULE_7__.UserAction.DELETE_POINT:
    ...
    _classPrivateFieldInitSpec(this, _renderSort, {
      writable: true,
      value: () => {
        _classPrivateFieldSet(this, _sortComponent, new _view_trip_sort_view_js__WEBPACK_IMPORTED_MODULE_3__["default"](_classPrivateFieldGet(this, _currentSortType)));

        _classPrivateFieldGet(this, _sortComponent).setSortTypeChangeHandler(_classPrivateFieldGet(this, _handleSortTypeChange));

        (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_0__.render)(_classPrivateFieldGet(this, _tripPointsElement), _classPrivateFieldGet(this, _sortComponent), _utils_render_js__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.AFTERBEGIN);
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _renderTripPoint, {
      writable: true,
      value: point => {
        const pointPresenter = new _point_presenter_js__WEBPACK_IMPORTED_MODULE_4__["default"](_classPrivateFieldGet(this, _tripPointsListElement), _classPrivateFieldGet(this, _handleViewAction), _classPrivateFieldGet(this, _handleModeChange));
    ...
    _classPrivateFieldInitSpec(this, _clearMain, {
      ...
      value: ({
        ...
        (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_0__.remove)(_classPrivateFieldGet(this, _sortComponent));
        ...
        if (_classPrivateFieldGet(this, _noTripPointsComponent)) {
          (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_0__.remove)(_classPrivateFieldGet(this, _noTripPointsComponent));
        }
      }
    });
  ...
  get points() {
    ...
    const filteredPoints = _utils_filter__WEBPACK_IMPORTED_MODULE_6__.filter[_classPrivateFieldGet(this, _filterType)](points);

    switch (_classPrivateFieldGet(this, _currentSortType)) {
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_7__.SortType.SORT_DAY:
        return filteredPoints.sort(_utils_point_sort_js__WEBPACK_IMPORTED_MODULE_8__.sortTaskByDay);

      case _utils_const_js__WEBPACK_IMPORTED_MODULE_7__.SortType.SORT_TIME:
        return filteredPoints.sort(_utils_point_sort_js__WEBPACK_IMPORTED_MODULE_8__.sortTaskByDuration);

      case _utils_const_js__WEBPACK_IMPORTED_MODULE_7__.SortType.SORT_PRICE:
        return filteredPoints.sort(_utils_point_sort_js__WEBPACK_IMPORTED_MODULE_8__.sortTaskByPrice);
    }
...
/* harmony export */ });
/* harmony import */ var _mock_destinations__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../mock/destinations */ "./src/mock/destinations.js");
/* harmony import */ var _mock_offers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../mock/offers */ "./src/mock/offers.js");
...
const createPointAddTemplate = point => {
  ...
  const pointTypesMarkup = (0,_utils_forms__WEBPACK_IMPORTED_MODULE_3__.createPointTypesMarkup)((0,_mock_offers__WEBPACK_IMPORTED_MODULE_1__.offers)(), type);
  const destinationOptions = (0,_mock_destinations__WEBPACK_IMPORTED_MODULE_0__.destinations)().map(x => `<option value="${x.name}"></option>`).join('');
  ...
  const editedOffersMarkup = (0,_utils_forms__WEBPACK_IMPORTED_MODULE_3__.createOffersSectionMarkup)((0,_mock_offers__WEBPACK_IMPORTED_MODULE_1__.offers)(), type);
...
class PointAddView extends _smart_view__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor(_point) {
    super();
    ...
    _classPrivateFieldInitSpec(this, _getChangedDestination, {
      ...
      value: destinationName => {
        const allDestinations = (0,_mock_destinations__WEBPACK_IMPORTED_MODULE_0__.destinations)();
...
_defineProperty(PointAddView, "createEmptyPoint", () => {
  const offerArray = (0,_mock_offers__WEBPACK_IMPORTED_MODULE_1__.offers)();
  const date = new Date();
  return {
    basePrice: null,
...
_defineProperty(PointAddView, "parsePointToData", point => ({ ...point
}));
...
const filterPresenter = new _presenter_filter_presenter__WEBPACK_IMPORTED_MODULE_3__["default"](tripControlsFiltersElement, filterModel);
