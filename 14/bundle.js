...
const createEventAddTemplate = tripEvent => {
  ...
  const addableOffersMarkup = (0,_utils_forms__WEBPACK_IMPORTED_MODULE_4__.createOffersSectionMarkup)(offers);
  const eventTypesMarkup = (0,_utils_forms__WEBPACK_IMPORTED_MODULE_4__.createEventTypesMarkup)((0,_mock_event_types__WEBPACK_IMPORTED_MODULE_2__.eventTypes)(), eventType);
...
class EventAddView extends _abstract_view__WEBPACK_IMPORTED_MODULE_3__["default"] {
...
const createEventEditTemplate = tripEvent => {
  ...
  const locationOptions = (0,_mock_locations__WEBPACK_IMPORTED_MODULE_1__.locations)().map(x => `<option value="${x}"></option>`).join('');
  const eventTypeLabel = eventType.charAt(0).toUpperCase() + eventType.slice(1);
  const editedOffersMarkup = (0,_utils_forms__WEBPACK_IMPORTED_MODULE_4__.createOffersSectionMarkup)(offers);
  const eventTypesMarkup = (0,_utils_forms__WEBPACK_IMPORTED_MODULE_4__.createEventTypesMarkup)((0,_mock_event_types__WEBPACK_IMPORTED_MODULE_2__.eventTypes)(), eventType);
  return `<li class="trip-events__item">
              <form class="event event--edit" action="#" method="post">
                <header class="event__header">
...
class EventItemView extends _abstract_view__WEBPACK_IMPORTED_MODULE_1__["default"] {
  ...
  get template() {
    return createEventsItemTemplate(_classPrivateFieldGet(this, _tripEvent));
  }
...
class NoTripEventsView extends _abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  get template() {
...
/* harmony import */ var _view_events_list_view_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./view/events-list-view.js */ "./src/view/events-list-view.js");
/* harmony import */ var _view_event_add_view_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./view/event-add-view.js */ "./src/view/event-add-view.js");
/* harmony import */ var _view_event_edit_view__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./view/event-edit-view */ "./src/view/event-edit-view.js");
/* harmony import */ var _view_event_item_view_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./view/event-item-view.js */ "./src/view/event-item-view.js");
/* harmony import */ var _view_no_trip_events_view__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./view/no-trip-events-view */ "./src/view/no-trip-events-view.js");
...
}, _mock_trip_event__WEBPACK_IMPORTED_MODULE_9__.generateTripEvent);
const tripControlsNavigationElement = document.querySelector('.trip-controls__navigation');
const tripControlsFiltersElement = document.querySelector('.trip-controls__filters');
const tripEventsElement = document.querySelector('.trip-events');
const tripEventsListElement = new _view_events_list_view_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
...
if (tripEvents.length === 0) {
  (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_0__.render)(tripEventsElement, new _view_no_trip_events_view__WEBPACK_IMPORTED_MODULE_8__["default"](), _utils_render_js__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.BEFOREEND);
} else {
  ...
  (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_0__.render)(tripEventsListElement.element, new _view_event_add_view_js__WEBPACK_IMPORTED_MODULE_5__["default"](tripEvents[0]), _utils_render_js__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.BEFOREEND);
}

const renderTripEvent = (tripEventListElement, tripEvent) => {
  const eventItemComponent = new _view_event_item_view_js__WEBPACK_IMPORTED_MODULE_7__["default"](tripEvent);
  const eventEditComponent = new _view_event_edit_view__WEBPACK_IMPORTED_MODULE_6__["default"](tripEvent);
